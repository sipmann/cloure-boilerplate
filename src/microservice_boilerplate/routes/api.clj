(ns microservice-boilerplate.routes.api
  (:require [microservice-boilerplate.ports.http-in.api :as ports.http-in.api]
    ...
    ["/deposit"
     {:post {:summary "do a deposit in btc in the wallet"
             ...
             :responses {201 {:body schemas.wire-in/WalletEntry}
                         400 {:body s/Str}
                         500 {:body s/Str}}
             :handler ports.http-in.api/do-deposit!}}]
    ...
    ["/withdrawal"
     {:post {:summary "do a withdrawal in btc in the wallet if possible"
             ...
             :responses {201 {:body schemas.wire-in/WalletEntry}
                         400 {:body s/Str}
                         500 {:body s/Str}}
             :handler ports.http-in.api/do-withdrawal!}}]]])
